...
public final class Constants {
  ...
  public static final class IntakeSubsystemConstants {
     ...
     */
    public static final double kIntakeSpeed = 0.4; // Intake speed Units are percentage
    ...
    public static final class PivotSetPoints {
      ...
      public static final double kPositionConversionFactorRel = 360 / 40.91; // Motor Rotation to Pivot Deg
      public static final double kVelocityConversionFactorRel = 360 / 40.91; // Motor RPM to Pivot Deg/min
